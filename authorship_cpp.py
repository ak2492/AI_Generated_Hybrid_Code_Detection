...
def extract_cpp_authorship(code):
    ...
    def traverse(node, depth):
        ...
        nonlocal cyclomatic, max_nest, lambdas, macros, oo_patterns
        ...
        if ntype in ['for_statement', 'while_statement', 'do_statement', 'for_range_loop']: loops += 1; cyclomatic += 1
        ...
        elif ntype in ['class_specifier', 'struct_specifier']: classes += 1
        elif ntype == 'template_declaration': oo_patterns += 1
    ...
    if words:
        keywords = {"int", "void", "return", "if", "else", "for", "while", "class", "public", "std"}
    ...
    features[20:36] = [node_count, max_depth, loops, conditionals, functions, classes, cyclomatic, max_nest, lambdas, macros, oo_patterns, switch_match, try_catch, returns, breaks, params]
    features[37] = chars
